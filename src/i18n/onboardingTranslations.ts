export const onboardingTranslations = {
  en: {
    ...
    register: {
      ...
      securityTitle: 'Account security', securityHelp: 'Use an email address you can access. We will send an eight-digit verification code.',
      ...
      legalAgreementNotice: 'By creating an account, you agree to the Terms of Service and Privacy Policy according to the version shown in each document.',
  ...
  ar: {
    ...
    register: {
      ...
      securityTitle: 'أمان الحساب', securityHelp: 'استخدم بريدًا يمكنك الوصول إليه. سنرسل إليك رمز تحقق من ثمانية أرقام.',
      ...
      legalAgreementNotice: 'بإنشاء الحساب، فإنك توافق على شروط الخدمة وسياسة الخصوصية وفق الإصدارات الموضحة في كل وثيقة.',
    ...
    verify: {
      title: 'تأكيد بريدك الإلكتروني', description: 'أدخل الرمز المكوّن من ثمانية أرقام المرسل إلى بريدك الإلكتروني.', digit: 'رقم التحقق', verify: 'تأكيد البريد', verifying: 'جارٍ التحقق…', resend: 'إعادة إرسال الرمز', resendIn: 'إعادة الإرسال خلال', sent: 'تم طلب رمز جديد. تحقق من صندوق الوارد والرسائل غير المرغوب فيها.', missing: 'بريد التسجيل غير متوفر. ارجع إلى إنشاء الحساب وحاول مجددًا.', invalid: 'الرمز غير صحيح. تحقق من الأرقام الثمانية وحاول مجددًا.', expired: 'انتهت صلاحية الرمز. اطلب رمزًا جديدًا.', used: 'استُخدم هذا الرمز مسبقًا. سجّل الدخول أو اطلب رمزًا جديدًا.', attempts: 'تجاوزت عدد المحاولات المسموح في هذه الصفحة. اطلب رمزًا جديدًا قبل المحاولة مرة أخرى.', rateLimit: 'تم بلوغ حد طلبات البريد. انتظر قبل طلب رمز آخر.', setup: 'تم تأكيد بريدك، ويجري الآن إعداد ملفك بأمان…', setupFailed: 'تم تأكيد بريدك، لكن إعداد الحساب لم يكتمل. يمكنك إعادة المحاولة بأمان.', retrySetup: 'إكمال إعداد الحساب'
    },
